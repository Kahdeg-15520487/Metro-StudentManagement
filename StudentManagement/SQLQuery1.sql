CREATE trigger AcademicMarkAverage
on AcademicMark
for insert, update
as
begin
...
CREATE proc GetListDisciplineForThisUser
...
create proc InsertRegisterStudyUnit
@StudentID nvarchar(10),
@Discipline nvarchar(10),
@SemesterID nvarchar(10)
as
begin
insert into RegisterStudyUnit values(@StudentID,@Discipline,@SemesterID)
end


alter table RegisterStudyUnit
drop column isregistered


delete RegisterStudyUnit